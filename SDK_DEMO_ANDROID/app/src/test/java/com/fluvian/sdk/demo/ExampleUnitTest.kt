...
import com.fluvian.sdk.core.EchelonProgramInfo
 ...
 *
 * Usage:
 *   Run via `./gradlew :app:testDebugUnitTest` from SDK_DEMO_ANDROID or the Fluvian SDK CI workflow.
 *
 * Usage example:
...
class ExampleUnitTest {
     ...
     * (README / PRD / ARCHITECTURE / publishing sketch) or releases drift. Fluvian SDK CI runs this module's unit tests.
     */
    @Test
